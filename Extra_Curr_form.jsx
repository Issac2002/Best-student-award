    ...
    return (
        ...
        <div style={containerStyle}>
            ...
            <div style={attStyle} className="animated-form">
                ...
                <h1 style={{ marginBottom: '2rem', color: '#2c3e50', fontFamily: 'Comic Sans MS' }}>Extra Curricular Activities</h1>
                    <div style={inputRowStyle}>
                        <label style={labelStyle}>Choose the activities you participated</label>
                        <select style={{ ...inputStyle, fontFamily: 'Comic Sans MS' }}>
                            <option value="" disabled selected>Select your activities</option>
                            <option>Sport</option>
                            <option>Indep</option>
                            <option>Other College Cultural</option>
                            <option>Art Work Competition</option>
                            <option>Others</option>
                        </select>
                    </div>
                    <div style={inputRowStyle}>
                        <label style={labelStyle}>District of the College (if other college) </label>
                        <input type="text" style={{ ...inputStyle, fontFamily: 'Comic Sans MS' }} placeholder='e.g: Trichy (Optional)'/>
                    </div>
                    <div style={inputRowStyle}>
                    ...
                    <div style={inputRowStyle}>
                        <label style={labelStyle}>Name of the particular category </label>
                        <input type="text" style={{ ...inputStyle, fontFamily: 'Comic Sans MS' }} placeholder='e.g: cricket'/>
                    </div>
                    <div style={inputRowStyle}>
                    ...
                    <div style={inputRowStyle}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            <input type="file" style={{ ...inputStyle, fontFamily: 'Comic Sans MS' }} accept=".pdf" />
                            <span style={{ color: 'red', position: 'relative',left: '80px' }}> * Only upload PDF files</span>
                        </div>
                    </div>
